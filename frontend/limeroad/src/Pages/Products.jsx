...
export const Products = () => {
  ...
  const { products, isloading, isadded } = useSelector(
  ...
  React.useEffect(() => {
    ...
    dispatch(getproductdata(obj)).then((res) => {
      console.log(res);
    });
    ...
    <Box
              ...
              <Grid templateColumns={"repeat(2,1fr)"} w={"90%"} margin={"auto"}>
                ...
                <GridItem
                  ...
                  <Stack gap={"0.3rem"}>
                    ...
                    <Box>
                      <Text>
                        M.R.P : <s> ₹{singleproduct.before_disc}</s>
                      </Text>
                    </Box>
                    ...
                    <Flex w={"70%"} justifyContent={"space-between"}>
                      <Box>
                        <Text color={"green"}>
                          You Save : {singleproduct.offer_percent}%
                        </Text>
                      </Box>
                      <Box>
                        {" "}
                    ...
                    <Box>
                      <Text color={"grey"}>M.R.P. inclusive of all taxes</Text>
                    </Box>
                    <Flex gap={"1rem"} border={"px solid brown"} w={"100%"}>
                      <Button
                        m={"auto"}
                        ...
                        onClick={() => {
                          ...
                          let arr1 = arr.map((ell) => {
                            if (ell._id === singleproduct._id) {
                              ...
                              return {
                                ...singleproduct,
                                Quantity: Number(ell.Quantity) + 1,
                              };
                            }
                            return ell;
                          });
                          if (flag === false) {
                            setdata([...data, singleproduct]);
                          } else {
                            setdata(arr1);
                          }
                          toast({
                      ...
                      <Button
                        ...
                        onClick={(e) => {
                          setloading(true);
                          dispatch(addtocartdata(singleproduct)).then((res) =>
                            setloading(false)
                          );
                          toast({
                            title: "Cart",
      ...
      <Flex
        ...
        <Box w={"20%"} border={"px solid pink"} padding={"1rem"}>
          <Text paddingTop={"1rem"} align={"left"}>
            Filter & Sort
          </Text>
        ...
        <Box w={"75%"} border={"px solid blue"}>
          <div className="pinkbanner" style={{ width: "100%", margin: "1rem" }}>
            <img
              ...
              src="https://img0.junaroad.com/images/icons/prepaid_resized.gif?imbypass=true"
              alt="logo"
            />
            <div
              style={{
              ...
              <p>
                <b>Pay Online & Get FLAT 10% OFF</b>
              </p>
      ...
      <Flex w={"100%"} justifyContent={"center"} margin={"1rem"}>
        {!isloading ? (
          <Pagination tp={tp} page={page} setpage={setpage} />
        ) : null}
      </Flex>
    </Box>
  );
