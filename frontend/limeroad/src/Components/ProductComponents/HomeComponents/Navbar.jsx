      ...
      <Box padding="0px 1%" mt="-3%" >
        <Flex
          ...
          <Flex flex={{ base: 1 }} justify={{ base: 'center', md: 'start' }} align="center">
            ...
            <Flex display={{ base: 'none', md: 'flex' }} ml={[10,15]} >
              <DesktopNav />
            </Flex>
          </Flex>
          ...
          <Stack
            ...
            variant={'link'}
            href={'/signup'}>
              <Image height={["15px","25px"]} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSI0PXgAh7ba4WdsiCzZWGTZOZK6OhDOi67mA&usqp=CAU"/>
